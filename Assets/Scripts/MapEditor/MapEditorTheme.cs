...
/// 에셋 위치: Assets/UI/MapEditorTheme.asset — 메뉴 [Chojiilgwan > Build MapEditor HUD] 가 없으면 만든다.
/// </summary>
...
public class MapEditorTheme : ScriptableObject
{
    ...
    {
#if UNITY_EDITOR
        return UnityEditor.AssetDatabase.LoadAssetAtPath<MapEditorTheme>("Assets/UI/MapEditorTheme.asset");
#else
        return null;
#endif
    }
